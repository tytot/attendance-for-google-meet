...
function attemptHook() {
    if (!hooked) {
        ...
        for (const [_k, v] of Object.entries(globalThis.default_MeetingsUi)) {
            if (v && v.prototype) {
                for (const k of Object.keys(v.prototype)) {
                    ...
                    if (p && p.value && !v.prototype[k].__grid_ran) {
                        ...
                        if (regex.test(funcString)) {
                            ...
                            console.log('Successfully hooked into function.')
                            console.log(v.prototype[k])
                            hooked = true
                        }
                    }
                }
